...
Sets are similar to dictionaries except that instead of having 
key/value pairs they only have the keys but not the values.
...
(meaning that duplicates are not allowed). 

They are useful for various operations such as finding the 
distinct elements in a collection and performing set operations 
such as union and intersection.

They are defined by either using curly braces {} 
or the built-in set() function like this:
'''
